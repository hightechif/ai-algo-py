...
- [x] **Task 1: Model the "From Scratch" Engine**
...
- [x] **Task 2: Model the "Framework" Engine**
...
- [x] **Task 3: Assemble the interactive Notebook**
...
- [x] **Task 4: Finalize Module Documentation**
